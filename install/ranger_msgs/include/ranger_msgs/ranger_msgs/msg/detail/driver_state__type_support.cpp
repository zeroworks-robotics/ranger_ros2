...
{
  new (message_memory) ranger_msgs::msg::DriverState(_init);
}

void DriverState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ranger_msgs::msg::DriverState *>(message_memory);
  typed_message->~DriverState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DriverState_message_member_array[4] = {
  {
    "driver_voltage",  // name
    ...
    offsetof(ranger_msgs::msg::DriverState, driver_voltage),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ranger_msgs::msg::DriverState, driver_temperature),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ranger_msgs::msg::DriverState, motor_temperature),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ranger_msgs::msg::DriverState, driver_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DriverState_message_members = {
  ...
  4,  // number of fields
  sizeof(ranger_msgs::msg::DriverState),
...
{
  return &::ranger_msgs::msg::rosidl_typesupport_introspection_cpp::DriverState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ranger_msgs, msg, DriverState)() {
  return &::ranger_msgs::msg::rosidl_typesupport_introspection_cpp::DriverState_message_type_support_handle;
}
