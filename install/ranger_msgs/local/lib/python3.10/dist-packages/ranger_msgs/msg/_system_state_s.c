...
bool ranger_msgs__msg__system_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ranger_msgs.msg._system_state.SystemState", full_classname_dest, 41) == 0);
  }
  ranger_msgs__msg__SystemState * ros_message = _ros_message;
  {  // header
...
PyObject * ranger_msgs__msg__system_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ranger_msgs.msg._system_state");
