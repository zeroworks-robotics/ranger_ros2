...
bool ranger_msgs__msg__driver_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ranger_msgs.msg._driver_state.DriverState", full_classname_dest, 41) == 0);
  }
  ranger_msgs__msg__DriverState * ros_message = _ros_message;
  {  // driver_voltage
  ...
  {  // driver_state
    ...
    ros_message->driver_state = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * ranger_msgs__msg__driver_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ranger_msgs.msg._driver_state");
